...
public class ImageUtil {
    private static String externalDirectoryPath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/schedule_images" ;
...
//    public static String saveCompressedImageIntoExternalStorage(File compossedImageFile){
//        File file = new File(externalDirectoryPath, compossedImageFile.getName());
//        try{
